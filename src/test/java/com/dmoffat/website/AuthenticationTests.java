 ...
 * - JWT parsing
 *
 * todo(dan): split into unit / integration tests, some of these tests don't require a Spring environment
 *
 * @author dan
 */
...
public class AuthenticationTests extends IntegrationTest {
    ...
    @Test
    public void shouldNotAllowNonUniqueUsernames() throws Exception {
        authenticationService.create(user);
    ...
    @Test
    public void shouldHashUsersPassword() throws Exception {
        authenticationService.create(user);
    ...
    // Test the form login
    @Test
    public void shouldLoginWithValidUsernameAndPassword() throws Exception {
        authenticationService.create(user);
        this.mockMvc
                .perform(
    ...
    @Test
    public void shouldNotLoginWithInvalidUsernameAndPassword() throws Exception {
    ...
    // a possiblity.
    @Test
    public void shouldCorrectlyParseJwt() throws Exception {
    ...
    @Test
    public void shouldCorrectlyDeclineInvalidJwt() throws Exception {
